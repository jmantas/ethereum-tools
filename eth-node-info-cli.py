...
def main():
    ...
    parser.add_argument("--host", dest="jrpc_host", default="127.0.0.1")
    parser.add_argument("--port", dest="jrpc_port", default="18801")    
    ...
    if args.blocknumber:
        print "Current block number:{}".format(eth_instance.current_block_number())
